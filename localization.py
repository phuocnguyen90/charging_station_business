...
UI_TEXTS = {
    "EN": {
        ...
        "sidebar": {
            ...
            "other_operational_cost": "Other Operational Cost ($/month)",
            "other_operational_cost_help": "Other operational costs per month (e.g., maintenance).",
    ...
    "VI": {
        ...
        "sidebar": {
            ...
            "installation_cost_help": "Chi phí lắp đặt và các chi phí đầu tư ban đầu khác.",
            "other_operational_cost": "Chi phí vận hành hàng tháng (đ/tháng)",
            "other_operational_cost_help": "Các khoản chi khác để vận hành hàng tháng như bảo dưỡng, thuê đất...",
